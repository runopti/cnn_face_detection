...
## Load data
data = np.load('data_calib_24')
target = np.load('target_calib_24')
...
pickle.dump(train_plt_loss, open('train_plt_loss', 'wb'), -1)
pickle.dump(test_plt_loss, open('test_plt_loss', 'wb'), -1)
pickle.dump(train_plt_accuracy, open('train_plot_accuracy', 'wb'), -1)
pickle.dump(test_plt_accuracy, open('test_plt_accuracy', 'wb'), -1)
