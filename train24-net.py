# -*- coding: utf-8 -*-
"""
Created on Sun Aug 23 21:45:16 2015
...
## Load data
facedata = np.load('data/facedata_24_color')
nonfacedata = np.load('data/nonfacedata_24_both')
data = np.concatenate((facedata, nonfacedata))
data12 = np.load('data/data_12_color')
target = np.load('data/target_24_both')
...
plt.xlabel("epoch")
plt.ylabel("accuracy")
plt.savefig("net24_accuracy.png")
